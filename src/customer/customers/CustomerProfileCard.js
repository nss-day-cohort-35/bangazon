...
export default class CustomerProfileCard extends Component {
	...
	render() {
		return (
			<Card className="CustomerProfileCard">
				<CardActionArea>
					<CardMedia
						component="img"
						alt="Customer"
					...
					<CardContent>
						...
						<Typography
							...
							className="customerId"
						>
							MAILING ADDRESS: Git out my business Ave Nashville
							TN, 37209
							{/* {this.props.} */}
						</Typography>
						<Typography
							...
							className="customerId"
						>
							E-MAIL ADDRESS: yallmadcauseyouaintme@haters.com
							{/* {this.props.} */}
						</Typography>
						<Typography
							variant="body2"
